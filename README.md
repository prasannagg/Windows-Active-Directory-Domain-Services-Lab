...
- Created domain users, security groups, and a role-based access model
...
Demonstrated password reset workflows, account unlock procedures, and enforced password changes at next logon.
...
- Used Item-Level Targeting for department-specific access control
...
Configured DHCP services to support domain operations and automatic client configuration.
...
This ensured proper domain integration and network functionality.
...
- Automated resource access using Group Policy & targeting
